...
articleEntityFromJson(ArticleEntity data, Map<String, dynamic> json) {
	...
	if (json['audit'] != null) {
		data.audit = json['audit']?.toDouble();
	}
	if (json['author'] != null) {
	...
	if (json['chapterId'] != null) {
		data.chapterId = json['chapterId']?.toDouble();
	}
	...
	if (json['courseId'] != null) {
		data.courseId = json['courseId']?.toDouble();
	}
	if (json['desc'] != null) {
	...
	if (json['publishTime'] != null) {
		data.publishTime = json['publishTime']?.toDouble();
	}
	if (json['realSuperChapterId'] != null) {
		data.realSuperChapterId = json['realSuperChapterId']?.toDouble();
	}
	if (json['selfVisible'] != null) {
		data.selfVisible = json['selfVisible']?.toDouble();
	}
	if (json['shareDate'] != null) {
		data.shareDate = json['shareDate']?.toDouble();
	}
	if (json['shareUser'] != null) {
		data.shareUser = json['shareUser']?.toString();
	}
	if (json['superChapterId'] != null) {
		data.superChapterId = json['superChapterId']?.toDouble();
	}
	...
	if (json['tags'] != null) {
		...
		(json['tags'] as List).forEach((v) {
			data.tags.add(new ArticleTag().fromJson(v));
		});
	}
	if (json['title'] != null) {
	...
	if (json['visible'] != null) {
		data.visible = json['visible']?.toDouble();
	}
	if (json['zan'] != null) {
		data.zan = json['zan']?.toDouble();
	}
	return data;
}
...
articleTagFromJson(ArticleTag data, Map<String, dynamic> json) {
	if (json['name'] != null) {
...
Map<String, dynamic> articleTagToJson(ArticleTag entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
